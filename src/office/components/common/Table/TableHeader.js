  ...
  render() {
    return <thead>
        <tr className="">
          ...
          <td style={getStyle("width", 70)}>Current %</td>
          <td className="text-center" style={getStyle("width", 90)}>Target % <FaInfoCircle /></td>
          <td className="text-center" style={getStyle("width", 90)}>Target $</td>
